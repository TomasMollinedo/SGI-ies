 ...
 * proyecto de las que no — hoy solo `EN_PLANIFICACION`
...
export const unidadPublicableListResponseSchema = z.object({
...
export class UnidadPublicableListResponseDto extends createZodDto(
  unidadPublicableListResponseSchema,
) {}
